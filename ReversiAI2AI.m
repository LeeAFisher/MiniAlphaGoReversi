...
%     gif;
%     [u,currentColor,pass] = AIrand(u,currentColor,pass);    
%     [u,currentColor,pass] = AINNPositionValue(u,currentColor,pass);   
%     [u,currentColor,pass] = AItreetop3(u,currentColor,pass,3,6);            
%     [u,currentColor,pass] = FisherAItree(u,currentColor,pass,2);  
%    [u,currentColor,pass] = AIMCTStop3(u,currentColor,pass,3000+k*10,20,10);
      [u,currentColor,pass] = FisherAIMCTS(u,currentColor,pass,3000+k*10,40);
    k = k + 1;
%     pause;
%     gif;
end
